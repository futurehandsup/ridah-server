...
router.get('/stores/detail/:storeNo', stores.getStoreDetail, stores.updateStore, common.setTitle('승마장 정보수정'), common.renderPage('newadmin/stores/detail'));
router.get('/stores/add', stores.addStore, common.setTitle('승마장 추가'), common.renderPage('newadmin/stores/add'));
...
router.get('/calculations/detail', calculations.getCalculationDetail, common.setTitle('정산내역 상세'), common.renderPage('newadmin/caculations/detail'))
...
router.get('/payments/detail', payments.getPaymentDetail, common.setTitle('결제관리 상세'), common.renderPage('newadmin/payments/detail'));
...
router.get('/members/detail', members.getMemberDetail, common.setTitle('사용자 상세'), common.renderPage('newadmin/members/detail'));
...
router.get('/banners/detail', banners.getBannerDetail, common.setTitle('배너 상세'), common.renderPage('newadmin/banners/detail'));
...
router.get('/faqs/detail', faqs.getFaqDetail, common.setTitle('자주묻는 질문 상세'), common.renderPage('newadmin/faqs/detail'));
...
router.get('/notices/detail', notices.getNoticeDetail, common.setTitle('공지사항 상세'), common.renderPage('newadmin/notices/detail'));
