...
// CalculationTaxSchema.virtual('idpass').get(function() {     // 가상 속성, CalculationTaxSchema 의 set 옵션에 virtuals 옵션을 true 로 설정해야 작동
//     return this.userid + ' ' + this.password;
// });
// CalculationTaxSchema.pre('save', function(next){
//   /*
...
// });
//
// CalculationTaxSchema.methods.hashPassword = function(password) {
//     /*
...
// };
//
// CalculationTaxSchema.methods.authenticate = function(password) {
//   //authenticate() 메소드는 문자열 인수를 받아들여 암호화하고 현재 사용자의 비밀번호와 비교한다.
//   return this.password === this.hashPassword(password);
// };
//
// CalculationTaxSchema.statics.findUniqueCalculationTaxid = function(userid, suffix, callback) {
//     /*
...
CalculationTaxSchema.set('toJSON',{ getters : true , virtuals : true});
...
mongoose.model('CalculationTax', CalculationTaxSchema);
